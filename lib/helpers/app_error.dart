  ...
  void log() {
    ...
    switch (type) {
      case ErrorType.network:
        logger.e('Network Error: $message', originalError, stackTrace);
        break;
      case ErrorType.authentication:
        logger.e('Authentication Error: $message', originalError, stackTrace);
        break;
      case ErrorType.validation:
        logger.w('Validation Error: $message', originalError, stackTrace);
        break;
      case ErrorType.unknown:
      default:
        logger.e('Unknown Error: $message', originalError, stackTrace);
    }
